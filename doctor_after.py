...
l2 = Label(root,text='Accepted Requests',font=('Gabriola',28,'bold'),bg='#8EAAF3')
l3 = Label(root,text='Name: ',font=('Gabriola',20,'bold'),bg='#8EAAF3')
l4 = Label(root,text='E-Mail:',font=('Gabriola',20,'bold'),bg='#8EAAF3')
b1 = Button(root,text='Accept Request',font=('Gabriola',20,'bold'),bg='#8EAAF3',width = 16)
...
treev.heading("2", text ="Patient Name")
treev.heading("3", text ="Status")
treev.heading("4", text ="Timing")
treev.heading("5", text ="Meeting Link")
